...
Contributors: recorp
Tags: export html, page to html, static, html, css, wp page, page, wp, save as html
Requires at least: 4
Tested up to: 5.4
Requires PHP: 5.4
Stable tag: 1.0.1
...
Export WP page to static html and css in just one click. 
...
*More plugins you may like*
  ...
  *[Mailchimp for divi](https://myrecorp.com/product/mailchimp-for-divi-contact-form/?clk=wp&a=readme)
