                                ...
                                <div class="input-group">
                                    ...
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select id="export_pages" name="export_pages">
                                            <option disabled="disabled" selected=""><?php _e('Choose a page', 'export-wp-page-to-static-html'); ?></option>
                                            
                                            <option value="homepage"><?php _e('Homepage ', 'export-wp-page-to-static-html'); echo '(' . home_url() . ')'; ?></option>
